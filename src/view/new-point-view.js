...
function createAddPointFormTemplate(point, allOffers, allDestinations) {
  ...
  const renderDestinationsList = allDestinations.map((dest) => `<option value="${dest.name}"></option>`).join('');
